...
for a = 0:0.01:2 * pi
    ...
    T_moon3 = [1 0 -6; 0 1 0; 0 0 1];
    R_moon3 = [cos(a_moon3) -sin(a_moon3) -T_moon2(1, 1, 1)*cos(a_moon3) + T_moon2(2, 1, 1)*sin(a_moon3) + T_moon2(1, 1, 1); sin(a_moon3) cos(a_moon3) -T_moon2(1, 1, 1)*sin(a_moon3)-T_moon2(1, 2, 1)*cos(a_moon3)+T_moon2(1, 2, 1); 0 0 1];
